    ...
    onMouseEnter: function (el, options) {
      ...
      this.bigImage.onload = function () {
        ...
        $(window).mousemove(function (e) {
          if (
            $(e.target).hasClass("mooZoom-overlay") ||
    ...
    onMouseMove: function (e, el) {
      ...
      if ($(detail).length === 0) {
        ...
        $(".mooZoom-big-detail").css({
          position: "absolute",
          top:
            parseInt(this._relTop) +
            parseInt(this.options.detail.margin.top) +
            "px",
          left:
            parseInt($(el).outerWidth(true)) +
            parseInt(this.options.detail.margin.left) +
            "px",
      ...
      var posBig =
        "-" + left.bg * this.factor + "px -" + top.bg * this.factor + "px";
